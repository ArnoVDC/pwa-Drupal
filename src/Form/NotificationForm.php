...
class  NotificationForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('authDomain', $this->firebase_code_clean['authDomain'])
      ->save();
    $config->set('databaseURL', $this->firebase_code_clean['databaseURL'])
      ->save();
    $config->set('projectId', $this->firebase_code_clean['projectId'])->save();
    $config->set('storageBucket', $this->firebase_code_clean['storageBucket'])
      ->save();
